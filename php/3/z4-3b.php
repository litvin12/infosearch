...
<body>
    ...
    for ($i = 1; $i <= 9; $i++) {
        $key = 'q' . $i;
        $answers[$i] = isset($_POST[$key]) ? intval(value: $_POST[$key]) : 0;
    }

    $correct = 0;
    for ($i = 1; $i <= 9; $i++) {
        if ($answers[$i] == $otv[$i - 1])
            $correct++;
    }
    ...
    switch ($correct) {
        case 9:
            $msg = 'великолепно знаете географию';
            break;
        case 8:
            $msg = 'отлично знаете географию';
            break;
        case 7:
            $msg = 'очень хорошо знаете географию';
            break;
        case 6:
            $msg = 'хорошо знаете географию';
            break;
        case 5:
            $msg = 'удовлетворительно знаете географию';
            break;
        case 4:
            $msg = 'терпимо знаете географию';
            break;
        case 3:
            $msg = 'плохо знаете географию';
            break;
        case 2:
            $msg = 'очень плохо знаете географию';
            break;
        default:
            $msg = 'вообще не знаете географию';
            break;
    }
